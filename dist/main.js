...
form.addEventListener("submit", (e) => {
  e.preventDefault();
  (0,_api__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelector("#location").value);
});
