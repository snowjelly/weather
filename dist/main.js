...
async function getYesterdaysWeatherData(location) {
  try {
    const today = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), `dd`);
    const yesterday = today - 1;
    const yesterdayFull = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), `yyyy-MM-${yesterday}`);
