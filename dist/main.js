...
async function saveLocationWeatherData() {
  const data = await (0,_api__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelector("#location").value);
  console.log(data);
