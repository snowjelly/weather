...
function renderStage2() {
  ...
  const favWeatherData = (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.getFavoriteWeatherData)();
...
form.addEventListener("submit", (e) => {
  e.preventDefault();
  removeErrors();
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.saveLocationWeatherData)()
...
function renderWeatherList() {
  const weatherDataArray = (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.getLocationWeatherData)();
