...
function getYesterday() {
  ...
  return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(yesterday), "yyyy-MM-dd");
}
...
/* harmony export */   renderStage2: () => (/* binding */ renderStage2)
/* harmony export */ });
...
async function renderStage2() {
  ...
  const favWeatherQuery = (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.getFavoriteWeatherData)().name;
  document.querySelector(".loading").setAttribute("visible", "");
  const favWeatherData = await (0,_api__WEBPACK_IMPORTED_MODULE_0__["default"])(favWeatherQuery);
  document.querySelector(".loading").removeAttribute("visible");
  favWeatherData.favorite = true;
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.saveFavoriteWeatherData)(favWeatherData);
...
form.addEventListener("submit", (e) => {
  e.preventDefault();
  removeErrors();
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.saveLocationWeatherData)()
...
function renderWeatherList() {
  const weatherDataArray = (0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.getLocationWeatherData)();
...
if ((0,_localStorage__WEBPACK_IMPORTED_MODULE_1__.getFavoriteWeatherData)() !== null) {
  (0,___WEBPACK_IMPORTED_MODULE_0__.removeForm)();
  (0,___WEBPACK_IMPORTED_MODULE_0__.renderStage2)();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getFavoriteWeatherData: () => (/* binding */ getFavoriteWeatherData),
/* harmony export */   getLocationWeatherData: () => (/* binding */ getLocationWeatherData),
/* harmony export */   saveFavoriteWeatherData: () => (/* binding */ saveFavoriteWeatherData),
/* harmony export */   saveLocationWeatherData: () => (/* binding */ saveLocationWeatherData)
/* harmony export */ });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ "./src/api.js");
...
async function saveLocationWeatherData() {
  ...
  const data = await (0,_api__WEBPACK_IMPORTED_MODULE_0__["default"])(locationName);
