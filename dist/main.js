...
form.addEventListener("submit", (e) => {
  e.preventDefault();
  removeErrors();
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.saveLocationWeatherData)().catch((err) => displayFormError(err));
});
